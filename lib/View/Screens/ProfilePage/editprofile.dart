...
class _EditProfileScreenState extends State<EditProfileScreen> {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: const Color.fromARGB(255, 62, 72, 79),),
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(color: const Color.fromARGB(255, 62, 72, 79), width: 2),
        ),
      ),
      validator: (value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_getTranslatedText('Edit Profile'),style: GoogleFonts.poppins(color: Colors.white,fontWeight: FontWeight.w800),),
        elevation: 0,
        backgroundColor: const Color.fromARGB(255, 62, 72, 79),
      ),
      body: Stack(
        children: [
          Container(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: const Color.fromARGB(255, 62, 72, 79),
                                  width: 3,
                                ),
                                boxShadow: [
                                  BoxShadow(
